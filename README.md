...
I put E8000 glue along the edge of one piece then pressing and aligning it on to the next piece by hand. This alignment step can be quite finicky as the difference in size of each layers is quite small. 
