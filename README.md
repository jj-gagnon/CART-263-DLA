...
- Points spawn at random places, and then move randomly in one of four directions per step. 
- If the points touch the center frozen point them stop moving and become frozen as well. 
- If a point wanders outside the image it gets deleted. 
